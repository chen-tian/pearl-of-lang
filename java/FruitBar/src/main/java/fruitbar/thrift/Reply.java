...
public class Reply implements org.apache.thrift.TBase<Reply, Reply._Fields>, java.io.Serializable, Cloneable {
  ...
  public Reply setResult(String result) {
    this.result = result;
    return this;
  }
  ...
  public Reply setPrice(int price) {
    this.price = price;
    setPriceIsSet(true);
    return this;
  }
